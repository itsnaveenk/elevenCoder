...
export function PortfolioCard({ title, problem, result, techStack, imageSrc, slug }: PortfolioCardProps) {
    return (
        <GlassCard className="flex flex-col h-full p-0 overflow-hidden group">
