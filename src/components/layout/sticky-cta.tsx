...
export function StickyCTA() {
    return (
        <>
            ...
            >
                <Link href="/contact">
                    <div className="glass-card p-1 pr-2 flex items-center gap-3 hover:scale-105 transition-transform cursor-pointer shadow-2xl">
            ...
            {/* Mobile Sticky Bar */}
            <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 p-4 glass-panel border-t border-white/20">
